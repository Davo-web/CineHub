import { popular } from '../api/api.js';

export async function renderPopular() {
    const cardBox = document.querySelector('.popular-box-card');
    ...
    try {
        ...
        cardBox.insertAdjacentHTML('beforeend', `<span class="loading-error">Failed to load popular movies</span>`)
    }
}